<template>
  <BaseModal :open="open" :title="title" :subtitle="subtitle" :title-id="titleId" @close="emit('close')">
    <template #headerIcon>
...
import { Folder, ChevronRight, Home, ArrowLeft, AlertCircle } from 'lucide-vue-next'
